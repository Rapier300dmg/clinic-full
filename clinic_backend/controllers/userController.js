...
class UserController {
  // Менеджер: получаем сразу пациентов/менеджеров и врачей
  ...
  // Любой авторизованный: свой профиль
  async getMe(req, res) {
    try {
  ...
  // Менеджер: профиль любого пользователя
  ...
  // Обновление (менеджер может любого, остальные — только себя)
  async updateUserById(req, res) {
    try {
      const { firstName, lastName, email, age } = req.body;
      // если не менеджер, проверяем, что id свой
